                ...
                demoRef.child("price").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (selectedId == -1 || selectedId1 == -1 || selectedId3 == -1 || selectedId4 == -1 || selectedId5 == -1) {
                            Toast.makeText(com.example.e_rec.desktop.this , "Please Select All The Conditions." , Toast.LENGTH_SHORT).show();
                        } else {
                    ...
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(com.example.e_rec.desktop.this , "" , Toast.LENGTH_SHORT).show();
                    }
                });
