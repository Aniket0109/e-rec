                ...
                demoRef.child("price").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(brand.equals("Select Brand")){
                            Toast.makeText(com.example.e_rec.refridgerator.this , "Select a Brand." , Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        if (selectedId == -1 || selectedId1 == -1 ) {
                            Toast.makeText(com.example.e_rec.refridgerator.this , "Please Select All The Conditions." , Toast.LENGTH_SHORT).show();
                        }
                            ...
                            accept.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    Intent intent = new Intent(getApplicationContext(), com.example.e_rec.location.class);
                    ...
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(com.example.e_rec.refridgerator.this , "" , Toast.LENGTH_SHORT).show();
                    }
                });
