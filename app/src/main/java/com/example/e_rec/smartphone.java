        ...
        fetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name)) {
                    Toast.makeText(com.example.e_rec.smartphone.this, "Please Enter Brand", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(model)) {
                    Toast.makeText(com.example.e_rec.smartphone.this, "Please Enter Model", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                demoref.child("price").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(value==null){
                            ...
                            Toast.makeText(com.example.e_rec.smartphone.this, "Please Select model with appropriate brand", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            progressBar.setVisibility(View.GONE);
                    ...
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(com.example.e_rec.smartphone.this , "enter correct model name and brand" , Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
