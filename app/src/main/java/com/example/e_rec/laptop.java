        ...
        fetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name)) {
                    Toast.makeText(com.example.e_rec.laptop.this, "Please Enter Brand", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(model)) {
                    Toast.makeText(com.example.e_rec.laptop.this, "Please Enter Model", Toast.LENGTH_SHORT).show();
                    return;
                }
