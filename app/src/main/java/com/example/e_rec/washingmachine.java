                ...
                demoRef.child("price").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(brand.equals("Select Brand")){
                            Toast.makeText(com.example.e_rec.washingmachine.this , "Select a Brand." , Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        if (selectedId == -1 || selectedId1 == -1 ) {
                            Toast.makeText(com.example.e_rec.washingmachine.this , "Please Select All The Conditions." , Toast.LENGTH_SHORT).show();
                        }
